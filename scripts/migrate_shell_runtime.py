...
if "CPPCHART_SHARED_RUNTIME_INTEGRATED" in text:
    print("shell_main.cpp already uses the shared exact runtime")
    raise SystemExit(0)
...
for forbidden in (
    ...
    if forbidden in text:
        raise RuntimeError(f"legacy state remains after migration: {forbidden}")

PATH.write_text("\ufeff" + text, encoding="utf-8")
print("Migrated shell_main.cpp to the shared exact runtime")
